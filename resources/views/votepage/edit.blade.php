...
@section('title', '投稿ページ編集')
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <h2>投票ページ編集</h2>
                 <form action="/votepage/edit" method="post" enctype="multipart/form-data">
                     @if (count($errors) > 0)
                        <ul>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-10">
                        <input type="text" class="form-control" name="name" value="{{ $votepage_form ->name }}">
                      </div>
                    </div>
                    <div class="form-group row">
                       <label class="col-md-2">タイトル</label>
                          <div class="col-md-10">
                            <input type="text" class="form-control" name="title" value="{{ $votepage_form->title }}">
                          </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-10">
                            <input type="hidden" name="id" value="{{ $votepage_form->id }}">
                            {{ csrf_field() }}
